...
"resource": {
  ...
  "tags":[{
      ...
      "vtp_dimension":["list",["map","index","1","dimension",["macro",1]],["map","index","2","dimension",["macro",2]],["map","index","3","dimension",["macro",3]],["map","index","4","dimension",["macro",4]]],
      "vtp_trackingId":"UA-26908291-1",
      "vtp_enableRecaptchaOption":false,
      "vtp_enableUaRlsa":false,
      "vtp_enableUseInternalVersion":false,
      ...
      "vtp_trackType":"TRACK_EVENT",
      "vtp_gaSettings":["macro",11],
      "vtp_eventAction":["template",["macro",19]," ",["macro",20],"%"],
      "vtp_eventLabel":["template",["macro",21]," | ",["macro",22],"s"],
      "vtp_enableRecaptchaOption":false,
      "vtp_enableUaRlsa":false,
      "vtp_enableUseInternalVersion":false,
      "vtp_enableFirebaseCampaignData":true,
      ...
      "vtp_conversionCookiePrefix":"_gcl",
      "vtp_conversionId":"1001175813",
      "vtp_conversionLabel":"EAy9CIuMzt0BEIX2st0D",
      "vtp_rdp":false,
      "vtp_url":["macro",7],
      "vtp_enableProductReportingCheckbox":true,
      "vtp_enableNewCustomerReportingCheckbox":false,
  ...
  "predicates":[{
      ...
      "function":"_re",
      "arg0":["macro",14],
      "arg1":"js-download-(drawer|hero|now)"
    },{
      "function":"_eq",
      "arg0":["macro",0],
      "arg1":"gtm.load"
  ...
  "rules":[
    [["if",0],["add",0,2,19,20,21,22,23,24,25,31,33]],
    [["if",0,1],["add",1]],
    [["if",0,2],["add",3]],
    [["if",0,3],["add",4,5]],
    [["if",0,4],["add",6]],
    ...
    [["if",18,19,20],["add",14]],
    [["if",21,22],["add",15]],
    [["if",6,23],["add",16,17,18]],
    [["if",24],["add",26]],
    [["if",0,15],["add",27,28,29,30]],
    [["if",25],["add",32]]]
},
"runtime":[]
...
var Ld=[C.B,C.J],Md=function(a){var b=a[C.Qd];b&&D(40);var c=a[C.Rd];c&&D(41);for(var d=Fa(b)?b:[b],e=0;e<d.length;++e)for(var f in a)if(a.hasOwnProperty(f)&&f!==C.Qd&&f!==C.Rd)if(-1<Ga(Ld,f)){var h=f,k=a[f],l=d[e];wd().set(h,k,l,"NL","NL-NB",c)}else{}},Nd=function(a,b){for(var c in a)if(a.hasOwnProperty(c))if(-1<
...
d,0))/h,1))*(1-Math.min((Math.max(0-e.top,0)+Math.max(e.bottom-c,0))/f,1)):0};var ee=/:[0-9]+$/,fe=function(a,b,c){for(var d=a.split("&"),e=0;e<d.length;e++){var f=d[e].split("=");if(decodeURIComponent(f[0]).replace(/\+/g," ")===b){var h=f.slice(1).join("=");return c?h:decodeURIComponent(h).replace(/\+/g," ")}}},je=function(a,b,c,d,e){b&&(b=String(b).toLowerCase());if("protocol"===b||"port"===b)a.protocol=he(a.protocol)||he(G.location.protocol);"port"===b?a.port=String(Number(a.hostname?a.port:G.location.port)||("http"==a.protocol?80:"https"==a.protocol?443:"")):"host"===b&&
...
function vf(a,b,c){for(var d=[],e=[],f,h=0;h<a.length;h++){var k=a[h],l=b(k);l===c?d.push(k):vo